        ...
        for (_i = 0, _len = projects.length; _i < _len; _i++) {
          ...
          _results.push((function(project) {
            ...
            task_request = HTTPS.request(options, function(res) {
              ...
              return res.on('end', function() {
                var ta, taskassignments, _fn, _j, _len1;
                try {
