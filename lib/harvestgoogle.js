...
Harvester = (function() {
  ...
  Harvester.prototype._3_googleharvested = function(events) {
    var deletable_harvest_entries, deleted_event_ids, entry, event, event_lookup, known_harvested_event_ids, matching_events, new_events, summary, updatable_harvest_entries, updated_event_ids, updated_events, _i, _len;
    ...
    for (_i = 0, _len = matching_events.length; _i < _len; _i++) {
      ...
      if ((event.start != null) && (event.duration_in_hours != null)) {
        (function(_this) {
          return (function(event) {
            return summary.push([event.summary, moment(event.start.dateTime != null ? event.start.dateTime : event.start.date).format("MMMM Do YYYY, H:mm:ss"), event.duration_in_hours, "" + event.matched_by.name, "ADD".green + (" " + event.matched_by.project_id + " " + event.matched_by.task_id)]);
          });
        })(this)(event);
      }
    }
    ...
    return ((function(_this) {
      return function(harvest, updates, deletes, creates) {
        ...
        return Prompt.get([
          ...
          var _fn, _fn1, _j, _k, _l, _len1, _len2, _len3, _results;
